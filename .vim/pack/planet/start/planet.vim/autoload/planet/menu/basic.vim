...
export def Update(): number
  if planet#menu#Visible('basic')
    ...
    execute planet#menu_help#Entry('an 110.100 ', '📁&f.File\ Manager\ Actions.Preview\ Selected\ File', '<Cmd>call planet#fern#Action(''preview'')<CR>')
    execute planet#menu_help#Entry('an 110.100 ', '📁&f.File\ Manager\ Actions.Expand\ Selected\ Tree', '<Cmd>call planet#fern#Action(''expand-tree:stay'')<CR>')
    execute planet#menu_help#Entry('an 110.100 ', '📁&f.File\ Manager\ Actions.Collapse\ Selected\ Tree', '<Cmd>call planet#fern#Action(''collapse'')<CR>')
    execute planet#menu_help#Entry('an 110.100 ', '📁&f.File\ Manager\ Actions.Paste\ Clipboard\ with\ Confirmation', '<Cmd>call planet#fern#Action(''clipboard-paste-confirm'')<CR>')
