...
call assert_true(!empty(menu_info('Highlights.Add Virtual Text After Line')))
call assert_match(':call planet#textprop#Note', execute('tmenu Highlights.Add\ Virtual\ Text\ After\ Line'))
call assert_equal('m{A-Z}', menu_info('Bookmarks.Set / Replace').accel)
